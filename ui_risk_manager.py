"""
ui_risk_manager.py
Streamlit/UI-side execution safety checks and circuit breakers.

This is intentionally separate from risk.py:
- risk.py = event-driven pre-trade gate in the execution framework
- ui_risk_manager.py = dashboard-side safety controller for the Streamlit surface
"""
...
class RiskManager:
    ...
    def mark_daily_pnl(self, pnl_fraction: float):
        """Set today's PnL as a fraction of capital for rerun-driven UI usage."""
